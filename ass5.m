...
J(1) = evaluatecostfunction2(X,y,w,lambda); 
...
J(i+1) = evaluatecostfunction2(X,y,w,lambda); %Calculating cost
W(i+1,1) = w(2); W(i+1,2) = w(3); 
end
...
figure; plot3(W(:,2),W(:,1),J,'color','r') ; grid ON;
%Batch gradient descent – Cost vs w1 and w2 
figure; contour(w2,w1,J1); hold on; 
plot(W(:,2),W(:,1),'color','r') %Contour plot 
clear i j
