table1 = readtable('/Users/harsha/Desktop/3-1/NNFL/assig 1/data4.xlsx');
...
p = randperm(50); %shuffling data %dividing data to 70% training data and 30% test data 
...
u1 = mean(t1(:,1:4))';
u2 = mean(t2(:,1:4))';
u3 = mean(t3(:,1:4))'; %calculating covariance matrix and determinant of covariance matrix 
E1 = t1(:,1:4)'*t1(:,1:4); 
E1_det = det(E1); 
E2 = t2(:,1:4)'*t2(:,1:4); 
E2_det = det(E2);
E3 = t3(:,1:4)'*t3(:,1:4);
E3_det = det(E3); yp = zeros(size(test_data,1),1); 
...
[~, yp(i)] = max([p_x_y1 p_x_y2 p_x_y3]);
%calculating ML output 
end
